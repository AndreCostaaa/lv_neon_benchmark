...
int main(void)
{
    color_format_t formats[] = {
        // { .name = "rgb565", .format = LV_COLOR_FORMAT_RGB565 },
        // { .name = "argb8888", .format = LV_COLOR_FORMAT_ARGB8888 }
        { .name = "rgb888", .format = LV_COLOR_FORMAT_RGB888 },
        { .name = "xrgb888", .format = LV_COLOR_FORMAT_XRGB8888 }
    };
    lv_init();
